  ...
  const services = [
    {
      ...
      features: ["مخططات 2D و 3D", "تراخيص البناء", "دراسة الموقع العام  مناظير   لاندسكيب ديكور خارجي ديكور داخلي" ,"إعداد الكشوف التقديرية  مع جداول تحليل الأسعار و دفاتر الشروط الفنية الخاصة ", "تخطيط عمراني"],
    },
    {
      id: "02",
      title: " الإنشاء و الإكساء والديكور الداخلي",
      icon: <FaHammer />,
      description:
        "نستلم عقارك من الترخيص و بكافة المراحل إلى التسليم بالمفتاح. تصاميم مودرن أو كلاسيك تناسب ذوقك وميزانيتك.",
      features: ["إنشاء على الهيكل ", "إكساء على المفتاح", "ترميم"],
    },
    {
      id: "03",
      ...
      features: ["إدارة الورشات و مراقبة تنفيذ المخططات الهندسية ", "ضبط الجودة", "الالتزام بالوقت"],
    },
    {
      id: "04",
      title: "الدراسات الزلزالية ",
      icon: <FaCity />,
      description:
        " دراسات إنشائية و زلزالية عبر برامج هندسية مناسبة. ",
      features: ["مذكرات حسابية و حساب كميات", "مخططات شوب دروينج", "دراسات التربة"],
    },
    {
      id: "05",
      ...
      icon: <FaFileContract />,
      description:
        "إعادة إحياء البيوت القديمة أو الشقق المستعملة وتحديث شبكات المياه والكهرباء .",
      features: ["معالجة الرطوبة", "تحديث البنية التحتية", "تعديل المخططات", "عزل حراري" ],
    },
    {
      id: "06",
      ...
      features: ["تخمين العقارات", "دراسة جدوى", "نصائح استثمارية"],
    },
  ];
